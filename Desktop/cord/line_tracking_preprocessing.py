...
def save_preprocessed_image(image, save_path, folder_name):
    """
    전처리된 이미지를 저장하는 함수
    """
...
def main():
    ...
    base_image_path = "/home/pi/AL_CAR/images"
    save_path = "/home/pi/AL_CAR"
    ...
    for folder_name in os.listdir(base_image_path):
        ...
        if os.path.isdir(folder_path):
            for image_name in os.listdir(folder_path):
                ...
                # 전처리된 이미지 저장
                save_preprocessed_image(processed_image, save_path, folder_name)
